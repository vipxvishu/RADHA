...
from RadhaXmusiC.misc import sudo
...
async def init():
    ...
    LOGGER("RadhaXmusiC.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await Anony.start()
    try:
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("RadhaXmusiC").info("Stopping AnonX Music Bot...")
